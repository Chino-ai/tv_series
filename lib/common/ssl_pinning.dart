...
class HttpSSLPinning {
  static Future<http.Client> get _instance async =>
      _IoclientInstance ??= await createLEClient();

  static http.Client? _IoclientInstance;

  static http.Client get client => _IoclientInstance ?? http.Client();

  static Future<void> init() async {
    _IoclientInstance = await _instance;
  }
  ...
  static Future<HttpClient> customHttpClient({
    ...
    HttpClient httpIOClient = HttpClient(context: context);
    httpIOClient.badCertificateCallback =
